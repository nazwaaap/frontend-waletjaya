        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-5">
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div className="flex-1 min-w-0">
              <h1 className="text-lg sm:text-xl font-bold truncate">Edit Pengguna</h1>
              <p className="text-xs text-white/70 truncate">Mengubah data pengguna walet jaya</p>
            </div>
            <UserCog className="w-6 h-6 text-yellow-400 hidden sm:block" />
          </div>
        </div>
      </div>
