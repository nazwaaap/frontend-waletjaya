        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-5">
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div className="flex-1 min-w-0">
              <h1 className="text-lg sm:text-xl font-bold truncate">Tambah Produk</h1>
              <p className="text-xs text-white/70 truncate">Tambahkan produk sarang burung walet baru</p>
            </div>
            <Package className="w-6 h-6 text-yellow-400 hidden sm:block" />
          </div>
        </div>
      </div>
            ...
            <div>
              ...
              {formData.hargaBeliPerKg && (
                <p className="text-xs text-gray-500 mt-1">
                  ≈ Rp {formatCurrency(formData.hargaBeliPerKg)}
                </p>
              )}
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  type="number"
                  name="beratDibeli"
                  value={formData.beratDibeli}
                  onChange={handleChange}
                  placeholder="2.5"
                  className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:ring-2 focus:ring-navy focus:border-navy outline-none transition-colors pr-12"
                  required
                  min="0.01"
                  step="0.01"
                />
