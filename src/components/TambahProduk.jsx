...
export default function TambahProduk() {
  ...
  const totalHargaBeli = hargaBeli * beratKotor;  // Harga beli tanpa ongkos
  const totalModalProduk = totalHargaBeli + ongkos;  // Total modal = harga beli + ongkos 
  const modalPerGram = beratBersih > 0 ? totalModalProduk / beratBersih : 0;  // Modal pergram dari total modal
