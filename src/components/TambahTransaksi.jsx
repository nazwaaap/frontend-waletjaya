          ...
          <div className="px-4 py-3">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <h1 className="text-base font-bold text-navy">Tambah Transaksi</h1>
                <p className="text-[10px] text-gray-500">Rekap pencatatan transaksi penjualan walet jaya yang sudah terjadi</p>
              </div>
              <ShoppingCart className="w-5 h-5 text-navy hidden sm:block" />
            </div>
          </div>
        </div>
                        ...
                        <div className="flex-1 space-y-1">
                          <div className="grid grid-cols-2 gap-2">
                            ...
                            <div>
                              ...
                              <span className="ml-2 font-semibold text-gray-900">Rp {formatCurrency(selectedProduct.totalModalProduk)}</span>
                            </div>
                            {selectedProduct.beratSusutGram > 0 && (
                              <div>
                                <span className="text-gray-600">Susut:</span>
                                <span className="ml-2 font-semibold text-gray-900">{selectedProduct.beratSusutGram} gram ({selectedProduct.persenSusut?.toFixed(1)}%)</span>
                              </div>
                            )}
                            <div>
                              <span className="text-gray-600">Stok Tersedia:</span>
                              <span className="ml-2 font-semibold text-gray-900">{selectedProduct.stokTersediaGram} gram</span>
                            </div>
                          </div>
