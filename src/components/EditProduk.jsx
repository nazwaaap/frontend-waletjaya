          ...
          <div className="px-4 py-3">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <h1 className="text-base font-bold text-navy">Edit Produk</h1>
                <p className="text-[10px] text-gray-500">Mengubah data produk sarang burung walet</p>
              </div>
              <Edit className="w-5 h-5 text-navy hidden sm:block" />
            </div>
          </div>
        </div>
                ...
                {beratKotor > 0 && beratBersih >= 0 && (
                  <div className="bg-blue-50 border border-gray-300 rounded-md p-3 space-y-2 text-sm">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-bold text-gray-700">{beratSusut.toFixed(0)} gram ({persenSusut.toFixed(2)}%)</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-700">Berat Bersih:</span>
                      <span className="font-bold text-gray-700">{beratBersih.toFixed(0)} gram</span>
                    </div>
                  </div>
                )}
