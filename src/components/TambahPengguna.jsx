          ...
          <div className="px-4 py-3">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <h1 className="text-base font-bold text-navy">Tambah Pengguna</h1>
                <p className="text-[10px] text-gray-500">Menambahkan pengguna baru ke sistem walet jaya</p>
              </div>
              <UserPlus className="w-5 h-5 text-navy hidden sm:block" />
            </div>
          </div>
        </div>
